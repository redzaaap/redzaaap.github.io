import{P as w}from"./PageAnchor-ca9Nql7M.js";import{d as h,c as l,a as _,w as o,b as c,r as p,i as y,t as x,k as C,o as n,_ as f,e as u,h as b,u as k,F as m,f as z,g as M,n as v}from"./index-DanU4xgs.js";const V=h({__name:"Contact",props:{mode:{},title:{},description:{}},setup(t){const s=t,r={pc:{width:"976px"},tablet:{width:"662px"},mobile:{width:"100%"}},a=l(()=>({width:r[s.mode].width})),i=l(()=>{let e=s.description;return e=e.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),e=e.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>'),e});return(e,T)=>{const d=p("el-text"),g=p("el-card");return n(),_(g,{style:C(a.value)},{header:o(()=>[c(d,{class:"head"},{default:o(()=>[y(x(t.title),1)]),_:1})]),default:o(()=>[c(d,{class:"content-text",size:"large",innerHTML:i.value},null,8,["innerHTML"])]),_:1},8,["style"])}}}),B=f(V,[["__scopeId","data-v-1421abf8"]]),I=["id"],N=h({__name:"ContactView",props:{screenMode:{}},setup(t){const s=[{id:"master",title:"研究生招生",description:`实验室每年有一定的学硕、专硕及博士生招生名额。我们聚焦于三维视觉与具身智能，致力于实现机器对三维世界的智能感知、理解与交互，欢迎对此方向有研究兴趣的同学加入我们。申请时请在邮件中附上个人简历、本科以来的成绩单、主要成果（论文、竞赛奖励）。
